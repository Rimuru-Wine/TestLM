...
MIRROR_HELP_MESSAGE = ["""<i>Send links/files along with cmd or reply to cmd to mirror or leech on Telegram or GDrive or DDLs with different Engines like RClone or qBit</i>
...
➲ <b><i>qBittorrent Seed</i></b>: -d or -seed
...
default_desp = {'AS_DOCUMENT': 'Default type of Telegram file upload. Default is False mean as media.',
                ...
                'TORRENT_TIMEOUT': 'Timeout of dead torrents downloading with qBittorrent in seconds. Int',
                ...
                'DEFAULT_LANG': 'Default language for the bot. Default is en.',
                'TG_PROXY': 'Proxy for Telegram. Format: {"scheme": "socks5", "hostname": "", "port": 1234, "username": "user", "password": "pass"}',
                'FFMPEG_CMDS': 'Custom FFMPEG commands.',
                'UPLOAD_PATHS': 'Custom upload paths.',
                'WEB_ACCESS_PASSWORD': 'Web access password for proxy.',
                'DISABLE_MEGA': 'Disable Mega download.',
                'DISABLE_TORRENTS': 'Disable Torrent download.',
                'DISABLE_LEECH': 'Disable Leech feature.',
                'DISABLE_BULK': 'Disable Bulk feature.',
                'DISABLE_MULTI': 'Disable Multi feature.',
                'DISABLE_SEED': 'Disable Seeding feature.',
                'DISABLE_FF_MODE': 'Disable Fast Forward mode.',
                'USE_IMAGES': 'Use images in status.',
                'IMG_SOURCES': 'Image sources for search.',
                'MEDIA_STORE': 'Store media in database.',
                'LEECH_FONT': 'Font for leech caption.',
                'THUMBNAIL_LAYOUT': 'Layout for thumbnails.',
                'GD_DL_LIMIT': 'Google Drive download limit.',
                'RC_DL_LIMIT': 'Rclone download limit.',
                'GD_DESP': 'Google Drive upload description.',
                'YT_DESP': 'YouTube upload description.',
                'YT_TAGS': 'YouTube upload tags.',
                'YT_CATEGORY_ID': 'YouTube category ID.',
                'YT_PRIVACY_STATUS': 'YouTube privacy status.',
                'SHOW_CLOUD_LINK': 'Show cloud link in leech.',
                'RSS_SIZE_LIMIT': 'RSS size limit.',
                'USER_TRANSMISSION': 'User transmission for leech.',
                'HYBRID_LEECH': 'Hybrid leech feature.'
                }
