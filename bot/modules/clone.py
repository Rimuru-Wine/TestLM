...
async def rcloneNode(client, message, link, dst_path, rcf, tag):
    ...
    cmd = [bot_cache['pkgs'][2], 'lsjson', '--fast-list', '--stat',
    ...
    cmd1 = [bot_cache['pkgs'][2], 'lsf', '--fast-list', '-R',
            '--files-only', '--config', config_path, destination]
    cmd2 = [bot_cache['pkgs'][2], 'lsf', '--fast-list', '-R',
            '--dirs-only', '--config', config_path, destination]
    cmd3 = [bot_cache['pkgs'][2], 'size', '--fast-list', '--json',
